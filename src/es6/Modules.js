...
// 자바스크립트는 원래 html을 지원하기 위해서 개발된 언어였기 때분에 html 문서 내에서 <script></script>나 <script src='파일경로'></script> 형태로 다른 자바스크립트의 내용을 사용했음
// 자바스크립트가 발전하면서 자바스크립트를 단순히 웹에서만 사용하는 것이 아니게 되어 외부 자바스크립트 내용을 사용하기 위한 방법이 여러 가지로 개발됨
...
// 사용법 :
// import {함수명1, 함수명2, ...} from 파일경로;  // 일반 export 로 지정된 것을 불러옴
