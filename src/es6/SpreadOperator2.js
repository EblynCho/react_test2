...
// 동일한 키를 사용한 데이터가 있을 경우, 뒤 쪽에 나오는 키의 값으로 합쳐짐
var combined = Object.assign({}, objOne, objTwo);  // other: 0 -> other: -1
console.log(combined);  // { one: 1, two: 2, other: -1, three: 3, four: 4 }

// 위에 있는 함수와 매개변수의 순서가 다르기 때문에 결과도 달라짐
var combined = Object.assign({}, objTwo, objOne);  // other: -1 -> other: 0
