...
// const : ES6 에서 추가된 상수 선언 방식
    ...
    // const 로 선언된 변수에 배열, object와 같은 데이터를 저장했을 경우 해당 배열 및 object의 요소의 데이터를 변경할 수 있음
...
// const 로 생성한 배열 혹은 object에 내장 함수 사용 시 데이터 추가, 삭제가 가능함
...
const arr3 = [];
const arr4 = arr3.concat(1);  // concat : 새 배열 생성
console.log(arr3);
console.log(arr4);
...
const arr6 = arr5.slice(0, 1);  // 원본 그대로
console.log(arr5);  // [ 1, 2, 3 ]
console.log(arr6);  // [ 1 ]

const [first, ...arr7] = arr5;
console.log(first);  // 1 -> first : 변수
console.log(arr7);  // [ 2, 3 ]


const obj3 = {name: '아이유', age: 30};
const obj4 = {...obj3, name: '유재석'};
const {name, ...obj5} = obj4;  // name : 진짜 변수, ...obj5 : object (obj4 이 가진 name 값 그대로 가짐)
console.log(obj3);
console.log(obj4);
console.log(name);
console.log(obj5);
